# SECM chum salmon forecast models
# Script written by Jim Murphy updated: 10/18/19
# adapted by Sara Miller 4/21/2023
...
variables %>%
  mutate (returns_log = log(returns),
          returns_age3_log = log(returns_age3),
          returns_age4_log = log(returns_age4),
          returns_age5_log = log(returns_age5),
          returns_age6_log = log(returns_age6))%>%
  filter(Ryear > 1996)%>%
  filter(Ryear < 2020)-> variables

# STEP 2: stepwise selection of the data; https://www.statology.org/stepwise-regression-r/
intercept_only <- lm(returns_log ~ 1, data=variables)
fitcal<-(lm(returns_log~SECM_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +ISTI20_MJJ, data=variables)) #**
fitcal1<-(lm(returns_log~SECM_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +Chatham_SST_MJJ, data=variables))
fitcal2<-(lm(returns_log~SECM_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +Chatham_SST_May, data=variables))
fitcal3<-(lm(returns_log~SECM_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +Chatham_SST_AMJJ, data=variables))
fitcal4<-(lm(returns_log~SECM_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +Chatham_SST_AMJ, data=variables))
fitcal5<-(lm(returns_log~SECM_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +Icy_Strait_SST_MJJ, data=variables))
fitcal6<-(lm(returns_log~SECM_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +Icy_Strait_SST_May, data=variables))
fitcal7<-(lm(returns_log~SECM_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +Icy_Strait_SST_AMJJ, data=variables))
fitcal8<-(lm(returns_log~SECM_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +Icy_Strait_SST_AMJ, data=variables))
fitcal9<-(lm(returns_log~SECM_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +NSEAK_SST_MJJ, data=variables))
fitcal10<-(lm(returns_log~SECM_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +NSEAK_SST_May, data=variables))
fitcal11<-(lm(returns_log~SECM_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +NSEAK_SST_AMJJ, data=variables))
fitcal12<-(lm(returns_log~SECM_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +NSEAK_SST_AMJ, data=variables))
fitcal13<-(lm(returns_log~SECM_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +SEAK_SST_MJJ, data=variables))
fitcal14<-(lm(returns_log~SECM_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +SEAK_SST_May, data=variables))
fitcal15<-(lm(returns_log~SECM_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +SEAK_SST_AMJJ, data=variables))
fitcal16<-(lm(returns_log~SECM_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +SEAK_SST_AMJ, data=variables))
fitcal17<-(lm(returns_log~SECM_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +PDO, data=variables)) #**
fitcal18<-(lm(returns_log~SECM_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +PDO_MJJ, data=variables))#**

fitcal19<-(lm(returns_log~hidden_falls_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +ISTI20_MJJ, data=variables)) #**
fitcal20<-(lm(returns_log~hidden_falls_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +Chatham_SST_MJJ, data=variables)) #**
fitcal21<-(lm(returns_log~hidden_falls_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +Chatham_SST_May, data=variables))
fitcal22<-(lm(returns_log~hidden_falls_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +Chatham_SST_AMJJ, data=variables))
fitcal23<-(lm(returns_log~hidden_falls_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +Chatham_SST_AMJ, data=variables))
fitcal24<-(lm(returns_log~hidden_falls_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +Icy_Strait_SST_MJJ, data=variables)) #**
fitcal25<-(lm(returns_log~hidden_falls_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +Icy_Strait_SST_May, data=variables))
fitcal26<-(lm(returns_log~hidden_falls_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +Icy_Strait_SST_AMJJ, data=variables)) #**
fitcal27<-(lm(returns_log~hidden_falls_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +Icy_Strait_SST_AMJ, data=variables)) #**
fitcal28<-(lm(returns_log~hidden_falls_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +NSEAK_SST_MJJ, data=variables)) #**
fitcal29<-(lm(returns_log~hidden_falls_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +NSEAK_SST_May, data=variables))
fitcal30<-(lm(returns_log~hidden_falls_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +NSEAK_SST_AMJJ, data=variables))#**
fitcal31<-(lm(returns_log~hidden_falls_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +NSEAK_SST_AMJ, data=variables))
fitcal32<-(lm(returns_log~hidden_falls_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +SEAK_SST_MJJ, data=variables)) #**
fitcal33<-(lm(returns_log~hidden_falls_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +SEAK_SST_May, data=variables))
fitcal34<-(lm(returns_log~hidden_falls_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +SEAK_SST_AMJJ, data=variables))#**
fitcal35<-(lm(returns_log~hidden_falls_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +SEAK_SST_AMJ, data=variables))
fitcal36<-(lm(returns_log~hidden_falls_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +PDO, data=variables)) #**
fitcal37<-(lm(returns_log~hidden_falls_CPUE+zoo_May+zoo_June+ zoo_July+July_length+July_weight+July_condition +PDO_MJJ, data=variables))#**

forward <- step(intercept_only, direction='forward', scope=formula(fitcal37), trace=0)
forward$anova
#view final model
...
# STEP #3: MODELS AND SUMMARY STATS
# define model names and formulas
model.names <- c(m1='SECM_CPUE',
               m2='SECM_CPUE + zoo_June',
               m3='SECM_CPUE + zoo_June + ISTI20_MJJ',
               m4='SECM_CPUE + ISTI20_MJJ',
               m5='SECM_CPUE + zoo_June + PDO',
               m6='SECM_CPUE + zoo_June + PDO_MJJ',
               m7='SECM_CPUE + PDO',
               m8='SECM_CPUE + PDO_MJJ',
               m9='hidden_falls_CPUE',
               m10='hidden_falls_CPUE + zoo_June',
               m11='hidden_falls_CPUE + ISTI20_MJJ',
               m12='hidden_falls_CPUE + zoo_June + Chatham_SST_MJJ + July_length',
               m13='hidden_falls_CPUE + zoo_June + Chatham_SST_AMJJ + July_length',
               m14='hidden_falls_CPUE + zoo_June + Icy_Strait_SST_MJJ + July_length',
               m15='hidden_falls_CPUE + zoo_June + Icy_Strait_SST_AMJJ + July_length',
               m16='hidden_falls_CPUE + zoo_June + Icy_Strait_SST_AMJ',
               m17='hidden_falls_CPUE + zoo_June + NSEAK_SST_MJJ + July_length',
               m18='hidden_falls_CPUE + zoo_June + NSEAK_SST_AMJJ + July_length',
               m19='hidden_falls_CPUE + zoo_June + SEAK_SST_MJJ',
               m20='hidden_falls_CPUE + zoo_June + SEAK_SST_AMJJ',
               m21='hidden_falls_CPUE + zoo_June + PDO',
               m22='hidden_falls_CPUE + zoo_June + PDO_MJJ',
               m23='hidden_falls_CPUE + zoo_June +ISTI20_MJJ')
model.formulas <- c(returns_log ~ SECM_CPUE,
                    returns_log ~ SECM_CPUE + zoo_June,
                    returns_log ~ SECM_CPUE + zoo_June + ISTI20_MJJ,
                    returns_log ~ SECM_CPUE + ISTI20_MJJ,
                    returns_log ~ SECM_CPUE + zoo_June + PDO,
                    returns_log ~ SECM_CPUE + zoo_June + PDO_MJJ,
                    returns_log ~ SECM_CPUE + PDO,
                    returns_log ~ SECM_CPUE + PDO_MJJ,
                    returns_log ~ hidden_falls_CPUE,
                    returns_log ~ hidden_falls_CPUE + zoo_June,
                    returns_log ~ hidden_falls_CPUE + ISTI20_MJJ,
                    returns_log ~ hidden_falls_CPUE + zoo_June + Chatham_SST_MJJ + July_length,
                    returns_log ~ hidden_falls_CPUE + zoo_June + Chatham_SST_AMJJ + July_length,
                    returns_log ~ hidden_falls_CPUE + zoo_June + Icy_Strait_SST_MJJ + July_length,
                    returns_log ~ hidden_falls_CPUE + zoo_June + Icy_Strait_SST_AMJJ + July_length,
                    returns_log ~ hidden_falls_CPUE + zoo_June + Icy_Strait_SST_AMJ,
                    returns_log ~ hidden_falls_CPUE + zoo_June + NSEAK_SST_MJJ + July_length,
                    returns_log ~ hidden_falls_CPUE + zoo_June + NSEAK_SST_AMJJ + July_length,
                    returns_log ~ hidden_falls_CPUE + zoo_June + SEAK_SST_MJJ,
                    returns_log ~ hidden_falls_CPUE + zoo_June + SEAK_SST_AMJJ,
                    returns_log ~ hidden_falls_CPUE + zoo_June + PDO,
                    returns_log ~ hidden_falls_CPUE + zoo_June + PDO_MJJ,
                    returns_log ~ hidden_falls_CPUE + zoo_June +ISTI20_MJJ)


# summary statistics of SEAK pink salmon harvest forecast models (seak_model_summary.csv)
seak_model_summary <- f_model_summary(harvest=variables$returns_log, variables=variables, model.formulas=model.formulas,model.names=model.names)
